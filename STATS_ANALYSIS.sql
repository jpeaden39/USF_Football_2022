Show the game date and opponent for remaining schedule in order they will occur.
...
5. Show USF's record for games they have played so far this year.
...
6. Show the number of wins and loses by location **Hard** (Use GROUP BY/ HAVING)
(SELECT location,
...
7. What is the Average rushing yards USF would need for them to win next week?
...
9. Show the number of rushing yards and passing yards for USF, along with the opponet for games played and to be played with the date?
...
10. Average number of offensive total yards, rushing yards, and passing yards per game

SELECT AVG(o_total_yards), AVG(o_pass_yards), AVG(o_rush_yards) from usf_offense_stats_fact

11. Find the total number of offensive yards, passing yards, and rushing yards this season?
